...
assert old_live_tab_end in content, "Could not find Live System tab end marker!"
...
assert old_after_live in content, "Could not find marker after loadLiveSystem!"
content = content.replace(old_after_live, new_after_live, 1)
...
# Find where loadLiveSystem() is called on tab switch
...
assert old_tab_switch in content, "Could not find tab switch call!"
content = content.replace(old_tab_switch, new_tab_switch, 1)
print("3. Added loadSessionEnergy() and loadHeartbeat() to tab switch")

# ============================================================
# 4. Add heartbeat interval (same as admin page: 60s)
# ============================================================

# Find the setInterval for loadLiveSystem and add heartbeat
...
assert old_interval in content, "Could not find loadLiveSystem interval!"
